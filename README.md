...
[![Go Report Card](https://goreportcard.com/badge/github.com/energeist/makesite)](https://goreportcard.com/report/github.com/energeist/makesite)
...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the mlog library. The documentation is located at https://github.com/jbrodriguez/mlog. My goal is to use it to generate leveled output in stdout, and are persisted & rotated over time in a written file.`
- [x] **Add, commit, and push to GitHub**.
